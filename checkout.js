...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const renderLayout = () => {
    ...
    // Isi seatMapHTML jika ada
    if (eventDetails.fields['Seat_Map']) {
        seatMapHTML = `<div class="form-section seat-map-container"><h3>Peta Kursi</h3><img src="${eventDetails.fields['Seat_Map'][0].url}" alt="Peta Kursi" class="seat-map-image"></div>`;
    }
